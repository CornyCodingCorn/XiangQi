...
export class BoardBase<IProps extends IBoardBaseProps, IStates extends IBoardBaseStates> extends React.Component<IProps, IStates> {
    ...
    public static get boardWidth(): number { return this._boardWidth; }
    public static get boardHeight(): number { return this._boardHeight; }
    public static get playAreaWidth(): number { return this._playAreaWidth; }
    public static get playAreaHeight(): number { return this._playAreaHeight;}

    private static _init(cellWidth: number, cellHeight: number, horizontalPadding: number, verticalPadding: number) {
